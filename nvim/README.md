Note: This is not my config. I have made many alterations to it, but am no longer using its git tracking
I wanted a clean start from my previous vim config, and wanted to take advantage of more neovim plugins and features.
